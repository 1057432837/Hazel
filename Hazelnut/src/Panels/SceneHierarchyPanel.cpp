...
namespace Hazel {
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity) {
		...
		DrawComponent<TransformComponent>("Transform", entity, [](auto& component) {
			...
			glm::vec3 rotaion = glm::degrees(component.Rotation);
			DrawVec3Control("Rotation", rotaion);
			component.Rotation = glm::radians(rotaion);
		...
		DrawComponent<Rigidbody2DComponent>("Regidbody 2D", entity, [](auto& component) {
		...
		DrawComponent<BoxCollider2DComponent>("Box Collider 2D", entity, [](auto& component) {
			...
			ImGui::DragFloat2("Density", &component.Density, 0.01f, 0.0f, 1.0f);
			ImGui::DragFloat2("Friction", &component.Friction, 0.01f, 0.0f, 1.0f);
			ImGui::DragFloat2("Restitution", &component.Restitution, 0.01f, 0.0f, 1.0f);
			ImGui::DragFloat2("Restitution Threshold", &component.RestitutionThreshold, 0.01f, 0.0f);
